...
getAllBooks: function() {// tulostaa koko bookArrayn konsolille
    console.log(this.BookArray);
},
getOneBook: function(x) {   //tulostaa sille argumenttina(x:n arvo) annetun kirjan tiedot
    console.log(this.BookArray[x]);
},
addBook(id_book, name, author, isbn) { //lisää sille annetun kirjan bookArrayhin (käytä push metodia)
   this.BookArray.push(id_book,name,author, isbn); 
}
};


book.addBook(16, "TBA", "Zelanshi", "0534613932");
book.getAllBooks();
book.getOneBook(9);